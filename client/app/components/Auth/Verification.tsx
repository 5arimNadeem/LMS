            ...
            <div className="mt-10 flex items-center justify-around">
                {Object.keys(verifyNumber).map((key, index) => (
                    <input
                        ...
                        key={key}
                        ref={inputRefs[index]}
                        className={`w-16 h-16 bg-transparent border-[3px] rounded-[10px] text-center text-[18px] font-Poppins outline-none text-black dark:text-white ${invalidError ? "shake border-red-500" : "border-gray-400"
                            }`}
