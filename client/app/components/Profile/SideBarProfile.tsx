...
const SideBarProfile: FC<Props> = ({
    ...
    return (
        <div className="w-full">
            <div
                className={`w-full flex items-center px-3 py-4 cursor-pointer ${active === 1 ? "dark:bg-slate-800 bg-gray-200" : "bg-transparent"
                    }`}
                onClick={() => setActive(1)}
            >
                <Image
            ...
            <div
                className={`w-full flex items-center px-3 py-4 cursor-pointer ${active === 2 ? "dark:bg-slate-800 bg-gray-200" : "bg-transparent"
                    }`}
                onClick={() => setActive(2)}
            >
